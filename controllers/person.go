...
func (idb *Controllers) GetPerson(c *gin.Context) {
	var (
...
func (idb *Controllers) GetPersons(c *gin.Context) {
	var (
...
func (idb *Controllers) CreatePerson(c *gin.Context) {
	var (
		person structs.Person
		result gin.H
	)
...
func (idb *Controllers) UpdatePerson(c *gin.Context) {
	id := c.Query("id")
	first_name := c.PostForm("first_name")
	last_name := c.PostForm("last_name")
...
func (idb *Controllers) DeletePerson(c *gin.Context) {
	var (
		person structs.Person
		result gin.H
	)
